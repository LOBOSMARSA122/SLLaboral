...
namespace Sigesoft.Server.WebClientAdmin.UI.ExternalUser
{
    public partial class FRM031F : System.Web.UI.Page
    {
        ...
        {
            var dataListForReport = new ServiceBL().ReportOsteoMuscular(_serviceId, Constants.OSTEO_MUSCULAR_ID_1);
        ...
        private DataSet GetAutorizacionDrogas()
        {
            ...
            var dataListForReport = serviceBL.GetReportAutorizacionDosajeDrogas(_serviceId, Constants.TOXICOLOGICO_COCAINA_MARIHUANA_ID, _ListaDosaje);
        ...
        private void ChooseReport(crConsolidatedReports rp, string componentId)
        {
            ...
            switch (componentId)
            {
                ...
                case Constants.OSTEO_MUSCULAR_ID_1:
                    ...
                    rp.SectionOsteo.SectionFormat.EnableSuppress = false;
                    break;
