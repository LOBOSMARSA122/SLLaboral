   ...
   public class InformeMedicoOcupacional
    {
           ...
           string RecoOsteoMus1, string RecoTamDer, string RecoOdon, string RecoPsico, string RecoRx, string RecoOit, string RecoOft, string Restricciton, string Aptitud)
       {
           ...
           try
           {
                ...
                Font fontTitle1 = FontFactory.GetFont(FontFactory.TIMES_ROMAN, 18, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
                Font fontTitle2 = FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
                Font fontTitleTable = FontFactory.GetFont(FontFactory.TIMES_ROMAN, 10, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.White));
                ...
                Font fontSubTitleNegroNegrita = FontFactory.GetFont(FontFactory.TIMES_ROMAN, 9, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));
                ...
                {
                    CellLogo = new PdfPCell(new Phrase("Sin Firma", fontColumnValue)) { HorizontalAlignment = PdfPCell.ALIGN_LEFT };
                }
            ...
            { 
               ...
               // Paragraph cTitle = new Paragraph("INFORME MÉDICO OCUPACIONAL", fontTitle2);
               ...
               // #endregion
                ...
                new PdfPCell(new Phrase("Protocolo: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_LEFT}, new PdfPCell(new Phrase(filiationData.v_NombreProtocolo, fontColumnValue)){HorizontalAlignment= Element.ALIGN_LEFT,Colspan=4 },                                    
                 new PdfPCell(new Phrase("Fecha-Hora de Exámen: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_LEFT,Colspan=3 }, new PdfPCell(new Phrase(filiationData.d_ServiceDate.Value.ToShortDateString(), fontColumnValue)){HorizontalAlignment= Element.ALIGN_LEFT,Colspan=3},   
                   
                };

                columnWidths = new float[] { 8f, 15f,15,15f,15f, 5f, 8f, 5f, 5f, 5f, 8f };
                ...
                if (xEvaNeuro != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("Evaluación Neurológica", fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                   
                ...
                if (xOsteo != null)
                {
                    ...
                    //Conclusiones
                    var Conclusiones = xOsteo.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.OSTEO_MUSCULAR_DESCRIPCION_ID);
                ...
                if (xPsico != null)
                {
                    ...
                    //Conclusiones
                    var Conclusiones1 = xPsico.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.PSICOLOGIA_APTITUD_PSICOLOGICA);
                    var Conclusiones2 = xPsico.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.PSICOLOGIA_RECOMENDACIONES_ESPECIFICAS);
                    ...
                    cells = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase(Conclusiones1 == null? "": Conclusiones1.v_Value1Name +"/ "+ Conclusiones2 == null? "":Conclusiones2.v_Value1Name, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },     
                ...
                if (xRx != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("Radiografía de Torax", fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                   
          ...
          #region CABECERA DETALLE 2
                ...
                var xBio2 = serviceComponent.Find(p => p.v_ComponentId == "");
                ...
                if (xAcidoUrico != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase(AcidoUrico.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xAntigenoPro != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase(AntigenoPro.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xBKDirecto != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase("", fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },     
                        new PdfPCell(new Phrase(BKDirecto.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xHDL != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase(HDL.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xLDL != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase(LDL.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xColesterolTotal != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase(ColesterolTotal.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xColesterolVLDL != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase(ColesterolVLDL.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xCreatina != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        new PdfPCell(new Phrase("Creatina", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT },                   
                        ...
                        new PdfPCell(new Phrase(Creatina.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xVIH != null)
                {
                    var VIH = xVIH.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_ELISA_REACTIVOS_EXAMEN_ELISA);
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase("", fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },     
                        new PdfPCell(new Phrase(VIH.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                ...
                if (xGlucosa != null)
                {
                    ...
                    cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase(Glucosa.v_MeasurementUnitName, fontColumnValue)){HorizontalAlignment = Element.ALIGN_CENTER },                                    
                    ...
                    cells = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase("Hemtaíes", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT },                   
                    ...
                    new PdfPCell(new Phrase("Eosinofilos", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT },                   
                    ...
                    new PdfPCell(new Phrase("Basofilos", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT },                   
                    ...
                    new PdfPCell(new Phrase("Morfología", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT },                   
               ...
               document.Add(filiationWorker);
                ...
                if (filiationData != null)
                {
                    if (filiationData.FirmaDoctor != null)
                        cellFirma = new PdfPCell(HandlingItextSharp.GetImage(filiationData.FirmaDoctor, 25, 25));
                    else
