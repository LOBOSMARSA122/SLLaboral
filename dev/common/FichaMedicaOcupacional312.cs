...
namespace NetPdf
{
    public class FichaMedicaOcupacional312
    {
                                                                    ...
                                                                    string filePDF)
        {
            ...
            Font fontTitle1 = FontFactory.GetFont("Arial", 18, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
            Font fontTitle2 = FontFactory.GetFont("Arial", 12, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
            Font fontTitleTable = FontFactory.GetFont("Arial", 10, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));
            ...
            Font fontSubTitleNegroNegrita = FontFactory.GetFont("Arial", 9, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));
            ...
            Font fontAptitud = FontFactory.GetFont("Arial", 9, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));
            ...
            {
                CellLogo = new PdfPCell(new Phrase("Sin Firma", fontColumnValue)) 
                                { HorizontalAlignment = PdfPCell.ALIGN_LEFT };
            }
            ...
            if (listAtecedentesOcupacionales != null && listAtecedentesOcupacionales.Count > 0)
            {
                ...
                foreach (var item in listAtecedentesOcupacionales)
                {
                    ...
                    //Columna OCUPACIÓN
                    cell = new PdfPCell(new Phrase(item.v_workstation, fontColumnValueAntecedentesOcupacionales)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE };
                    cells.Add(cell);

                    //Crear Tabla en duro FECHA
                    List<PdfPCell> cells1 = new List<PdfPCell>();
                    cells1.Add(new PdfPCell(new Phrase("Inicio: ", fontColumnValueAntecedentesOcupacionales)));
                    cells1.Add(new PdfPCell(new Phrase(item.d_StartDate.Value.ToString("MM/yyyy"), fontColumnValueAntecedentesOcupacionales)));

                    cells1.Add(new PdfPCell(new Phrase("Fin: ", fontColumnValueAntecedentesOcupacionales)));
            ...
            {
                cells.Add(new PdfPCell(new Phrase("No se han registrado datos.", fontColumnValueAntecedentesOcupacionales)) { Colspan = 8, HorizontalAlignment = PdfPCell.ALIGN_LEFT });
                columnWidths = new float[] { 15f, 15f, 15f, 15f, 15f, 15f, 15f };
            }
            ...
            {
                ConcatenadoOtros = ConcatenadoOtros + " Perímetro Cadera : " + PerimetroCadera + "; ";
            }

            if (PerimetroAbdominal != "0.00" && PerimetroAbdominal != "0,00" && PerimetroAbdominal != string.Empty)
            {
                ConcatenadoOtros = ConcatenadoOtros + "Perímetro Abdominal : " + PerimetroAbdominal + "; ";
            }
            ...
            string TestEstereopsisNormal = Oftalmologia.Count() == 0 || ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_NORMAL_ID)) == null ? string.Empty : ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_NORMAL_ID)).v_Value1;
            string TestEstereopsisAnormal = Oftalmologia.Count() == 0 || ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_ANORMAL_ID)) == null ? string.Empty : ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_ANORMAL_ID)).v_Value1;
            string TiempoEstereopsis = Oftalmologia.Count() == 0 || ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_TIEMPO_ID)) == null ? string.Empty : ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ESTEREOPSIS_TIEMPO_ID)).v_Value1;
            ...
            string TestIshiharaNormal = Oftalmologia.Count() == 0 || ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ISHIHARA_NORMAL_ID)) == null ? string.Empty : ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ISHIHARA_NORMAL_ID)).v_Value1;
            string TestIshiharaAnormal = Oftalmologia.Count() == 0 || ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ISHIHARA_ANORMAL_ID)) == null ? string.Empty : ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_TEST_ISHIHARA_ANORMAL_ID)).v_Value1;
            string Dicromatopsia = Oftalmologia.Count() == 0 || ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_DICROMATOPSIA_ID)) == null ? string.Empty : ((ServiceComponentFieldValuesList)Oftalmologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.OFTALMOLOGIA_DICROMATOPSIA_ID)).v_Value1;
            ...
            cells = new List<PdfPCell>()
               {
                    ...
                    new PdfPCell(new Phrase("ICC", fontColumnValue))
                                     { HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase(ICC == "0" ? " " : ICC, fontColumnValue)),
                    ...
                    new PdfPCell(new Phrase(Temperatura == "0.00" || Temperatura == "0,00" || string.IsNullOrEmpty(Temperatura) ? "Afebril" : double.Parse(Temperatura).ToString("#.#"), fontColumnValue)),
            ...
            var AreaCognitiva = Psicologia.Count() == 0 || ((ServiceComponentFieldValuesList)Psicologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.PSICOLOGIA_APTITUD_PSICOLOGICA)) == null ? string.Empty : ((ServiceComponentFieldValuesList)Psicologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.PSICOLOGIA_APTITUD_PSICOLOGICA)).v_Value1;

            var AreaEmocional = Psicologia.Count() == 0 || ((ServiceComponentFieldValuesList)Psicologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.PSICOLOGIA_RECOMENDACIONES_ESPECIFICAS)) == null ? string.Empty : ((ServiceComponentFieldValuesList)Psicologia.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.PSICOLOGIA_RECOMENDACIONES_ESPECIFICAS)).v_Value1;
            ...
            if (Psicologia.Count() != 0)
            {
                cells = new List<PdfPCell>()
                  {
                       //fila
                        new PdfPCell(new Phrase(AreaCognitiva + ", " + AreaEmocional , fontColumnValue)), 
                         //fila
            ...
            {
                cells.Add(new PdfPCell(new Phrase("Conclusiones Radiográficas: " + ConclusionesRadiograficaDescripcion, fontColumnValue)));
            }
            ...
            var ComponentegrupoFactorSanguineo = ExamenesServicio.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.GRUPO_Y_FACTOR_SANGUINEO_ID);
            ...
            DiagnosticosLaboratorio = DiagnosticosLaboratorio == "" ? string.Empty : DiagnosticosLaboratorio.Substring(0, DiagnosticosLaboratorio.Length - 1);
            cells = new List<PdfPCell>();

            string vvv = "";

            if (!string.IsNullOrEmpty(filiationData.v_BloodGroupName) && ComponentegrupoFactorSanguineo != null)
            {
                vvv = string.Format("Grupo y factor sanguineo : \"{0}\" - {1}", filiationData.v_BloodGroupName.Trim(), filiationData.v_BloodFactorName);
            }
            ...
            if (existeAudio != null) // El examen esta contemplado en el protocolo del paciente
            {
                ...
                var ListaAudioMetriaDx = ListDiagnosticRepository.FindAll(p => p.v_ComponentId == Sigesoft.Common.Constants.AUDIOMETRIA_ID && p.i_FinalQualificationId !=  (int)Sigesoft.Common.FinalQualification.Descartado);
            ...
            if (existeEspiro != null) // El examen esta contemplado en el protocolo del paciente
            {
                ...
                if (Espirometria.Count() != 0)
                {
                    cells = new List<PdfPCell>()
                        {
                           //fila
                            new PdfPCell(new Phrase(ResultadoEspirometria + "," + ObservacionEspirometria, fontColumnValue)), 
                               //fila
            ...
            if (DataService.FirmaMedicoMedicina != null)
                cellFirma = new PdfPCell(HandlingItextSharp.GetImage(DataService.FirmaMedicoMedicina, 25, 25));
            else
        ...
        private static PdfPTable TableBuilderReportFor312(ServiceComponentList serviceComponent, Font fontTitle, Font fontSubTitle, Font fontColumnValue, BaseColor SubtitleBackgroundColor)
        {
            ...
            switch (serviceComponent.v_ComponentId)
            {
                ...
                case Sigesoft.Common.Constants.OSTEO_MUSCULAR_ID_1:
                    ...
                    if (serviceComponent.ServiceComponentFields.Count > 0)
                    {
                        var conclusion = serviceComponent.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.OSTEO_MUSCULAR_DESCRIPCION_ID);
                        var hallazgos = serviceComponent.DiagnosticRepository;
                        var join = string.Join(",", hallazgos.Select(p => p.v_DiseasesName));
