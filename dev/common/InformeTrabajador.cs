...
namespace NetPdf
{
   ...
   public class InformeTrabajador
   {
       ...
       public static void CreateFichaMedicaTrabajador2(PacientList filiationData,ServiceList doctoPhisicalExam, List<DiagnosticRepositoryList> diagnosticRepository, organizationDto infoEmpresaPropietaria, string filePDF)
       {
           ...
           Font fontTitle1 = FontFactory.GetFont(FontFactory.TIMES_ROMAN, 10, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));
           ...
           Font fontTitleTableAntecedentesOcupacionales = FontFactory.GetFont(FontFactory.TIMES_ROMAN, 6, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));
           Font fontColumnValueAntecedentesOcupacionales = FontFactory.GetFont(FontFactory.TIMES_ROMAN, 6, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.Black));
           ...
           #region Title
           Paragraph cTitle = new Paragraph("INFORME PARA EL TRABAJADOR", fontTitle1);
           ...
           else if (doctoPhisicalExam.FirmaDoctor != null)
           {
               cellFirma = new PdfPCell(HandlingItextSharp.GetImage(doctoPhisicalExam.FirmaDoctor, null, null, 120, 45));
           }
           else
           {
               cellFirma = new PdfPCell(new Phrase("Sin Firma", fontColumnValue));
