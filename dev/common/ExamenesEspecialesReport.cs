        ...
        public static void CreateLaboratorioReport(PacientList filiationData, List<ServiceComponentList> serviceComponent, organizationDto infoEmpresaPropietaria, string filePDF)
        {
            ...
            try
            {
                ...
                if (xSubUnidad != null)
                    ...
                    cells.Add(new PdfPCell(new Phrase(" ", fontColumnValue)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    cells.Add(new PdfPCell(new Phrase("RESULTADO", fontTitleTableNegro)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    cells.Add(new PdfPCell(new Phrase(ResultadoSubUnidad.v_Value1Name, fontColumnValue)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    cells.Add(new PdfPCell(new Phrase("DESEABLE", fontTitleTableNegro)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    cells.Add(new PdfPCell(new Phrase(ResultadoSubUnidad.v_Value1, fontColumnValue)) { HorizontalAlignment = Element.ALIGN_CENTER });

                    cells.Add(new PdfPCell(new Phrase("OBSERVACIÓN", fontTitleTableNegro)));
                    cells.Add(new PdfPCell(new Phrase(ResultadoSubUnidad.v_Value1, fontColumnValue)) { Colspan = 4, HorizontalAlignment = Element.ALIGN_LEFT });
                ...
                if (xVdrl != null)
                {
                    ...
                    cells.Add(new PdfPCell(new Phrase(" ", fontColumnValue)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    cells.Add(new PdfPCell(new Phrase("RESULTADO", fontTitleTableNegro)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    cells.Add(new PdfPCell(new Phrase(ResultadoVdrl.v_Value1Name, fontColumnValue)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    cells.Add(new PdfPCell(new Phrase("DESEABLE", fontTitleTableNegro)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    cells.Add(new PdfPCell(new Phrase(DeseableVdrl.v_Value1, fontColumnValue)) { HorizontalAlignment = Element.ALIGN_CENTER });
