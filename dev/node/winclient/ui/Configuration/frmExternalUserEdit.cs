...
{
    public partial class frmExternalUserEdit : Form
    {
        #region Declarations
        ...
        public frmExternalUserEdit(string mode, string personId, int? systemUserId, string protocolId)
        {
            InitializeComponent();
            _personId = personId;
        ...
        private void frmExternalUserEdit_Load(object sender, EventArgs e)
        {
            LoadData();
        }
