    ...
    public partial class frmHistory : Form
    {
        ...
        private void btnOtros_Click(object sender, EventArgs e)
        {
            ...
            if (findResult == null)
            {
                ...
                objPersonMedicalHistory.v_GroupName = "";
        ...
        private void btnOtrosFamilyMedical_Click(object sender, EventArgs e)
        {
            ...
            History.frmFamilyMedicPopup frmFamilyMedicAntecedentPopup = new History.frmFamilyMedicPopup(objDiseasesList.v_Name, "", _GroupPopupFamilyMedical);
        ...
        private void btnMoveFamilyMedical_Click(object sender, EventArgs e)
        {
            ...
            History.frmFamilyMedicPopup frm = new History.frmFamilyMedicPopup(treeViewFamilyMedicalAntecedents.SelectedNode.Text, "", objSystemParameterList1.v_Value1);
            frm.ShowDialog();
            if (frm.DialogResult != System.Windows.Forms.DialogResult.OK) return;
            string DiseasesId = objSystemParameterList.v_DiseasesName;
            int ParameterId = objSystemParameterList.i_ParameterId;
            //Busco en la lista temporal si ya se agrego el item seleccionado
            var findResult = _TempFamilyMedicalAntecedentsList.Find(p => p.i_TypeFamilyId == ParameterId);
            if (findResult == null)
            {
                ...
                objFamilyMedicalAntecedents.v_DiseasesId = DiseasesId;
        ...
        {
            History.frmFamilyMedicPopup frm = new History.frmFamilyMedicPopup(_DiagnosticName, _CommentFamilyMedic, _TypeFamilyName);
            frm.ShowDialog();
