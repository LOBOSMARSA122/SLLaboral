<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLogin.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.frmLogin" %>
...
<body>  
  <form id="form1" runat="server">
    ...
    <x:Window ID="Window1" runat="server" Title="Acceso al sistema: " IsModal="false" EnableClose="false"
        ...
        <Items>
            <x:Panel runat="server" ID="Panel1" Layout="Container" Title="LABORAL SYSTEM">
                <Items>
                     <x:Image runat="server" ID="Logo"  ImageUrl="~/images/logo/LogoLaboral.png"></x:Image>
                </Items>
            </x:Panel>
             <x:GroupPanel runat="server" Title="Información de Aplicación" ID="GroupPanel2" AutoWidth="true" BoxFlex="1" Height="70" >                
               <Items>
                    <x:SimpleForm ID="SimpleForm2" runat="server" ShowBorder="false" BodyPadding="10px"
                        ...
                        <Items>                   
                            <x:TextBox ID="TextBox1" Label="Sede" Required="true" runat="server" Text="Laboral Medical" Readonly="true">
                            </x:TextBox>
                        </Items>
                    </x:SimpleForm>
                </Items>
