...
<body>
   <form id="form1" runat="server">      
    <x:Pagemanager ID="PageManager1" runat="server" AutoSizePanelID="Panel1" />
     <x:Panel ID="Panel1" runat="server"  ShowBorder="True" ShowHeader="True" Title="Administrador de Servicios" EnableBackgroundColor="true" Layout="VBox" 
        ...
        <Items>
            ...
            EnableMouseOverColor="true" ShowGridHeader="true"   DataKeyNames="v_ServiceId,v_IdTrabajador,EmpresaCliente" 
                    ...
                    <x:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                            ...
                            <x:Button ID="btnNewExamenes" Text="Examenes" Icon="PageWhiteStack" runat="server" Enabled="false" Visible ="false"></x:Button>   
                             <x:Button ID="btnAdjuntar" Text="Ver Archivo Adjunto" Icon="attach" runat="server" Enabled="false" Visible="false" ></x:Button>                        
                        </Items>
                    </x:Toolbar>
                </Toolbars>
                <Columns>
                    <x:WindowField ColumnID="myWindowField" Width="125px" WindowID="Window1" HeaderText="Archivos Adjuntos"
                        Icon="attach" ToolTip="Editar Grupo" DataTextFormatString="{0}"
                        DataIFrameUrlFields="v_IdTrabajador" DataIFrameUrlFormatString="FRM031G.aspx?PersonId={0}" 
    ...
    <x:Window ID="winEdit3" IconUrl="~/images/16/11.png" runat="server" Popup="false"
        ...
        EnableIFrame="true" IFrameUrl="about:blank" Height="350px" Width="280px"  OnClose="winEdit3_Close">
    </x:Window>
