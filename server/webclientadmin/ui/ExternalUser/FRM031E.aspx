<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM031E.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.ExternalUser.FRM031E" %>
...
<form id="form1" runat="server">
    <x:PageManager ID="PageManager1" AutoSizePanelID="Panel5" runat="server" />
        <x:Panel ID="Panel5" runat="server" ShowBorder="True" BodyPadding="5px" ShowHeader="False"
            ...
            <Toolbars>
                <x:Toolbar ID="Toolbar1" runat="server">
                    <Items>    
                         <x:Button ID="btnSaveRefresh" Text="Visualizar" runat="server" Icon="Eye" Enabled="false" ValidateForms="SimpleForm1" TabIndex="7">
                         </x:Button>                  
                ...
                <x:Panel ID="Panel2" EnableBackgroundColor="true"
                    ...
                    <Items>                  
                        <x:GroupPanel runat="server" Title="Seleccionar Ficha(s)" ID="GroupPanel1" EnableBackgroundColor="True" AutoWidth="true">
                            <Items>
                                <x:CheckBoxList ID="chklExamenes" Label="" ShowLabel="false" ColumnNumber="1" ColumnVertical="true"
                                    runat="server" AutoPostBack="true" OnSelectedIndexChanged="chklExamenes_SelectedIndexChanged">
                                </x:CheckBoxList>
                            </Items>
                        </x:GroupPanel>
                    </Items>
        ...
        Title="Vizualizador de Fichas Ocupacionales" EnableConfirmOnClose="true" CloseAction="HidePostBack"
        EnableIFrame="true" IFrameUrl="about:blank" Height="630px" Width="700px">
    </x:Window>
    </form>
</body>
</html>
