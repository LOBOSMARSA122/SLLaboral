...
namespace Sigesoft.Server.WebClientAdmin.BE
{
    ...
    public partial class medicationDto
    {
        ...
        public medicationDto(String v_MedicationId, String v_ServiceId, String v_ProductId, String v_ProductName, String v_PresentationName, Nullable<Single> r_Quantity, Nullable<Single> r_QuantityVendida, String v_Doses, Nullable<Int32> i_ViaId, Nullable<Int32> i_SeVendio, Nullable<Int32> i_SeCreoAca, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, serviceDto service)
        {
