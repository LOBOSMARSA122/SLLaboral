    ...
    public class CertificadoAptitudCompleto
    {
        ...
        public static void CreateCertificadoAptitudCompleto(List<DiagnosticRepositoryList> filiationData, organizationDto infoEmpresaPropietaria, List<DiagnosticRepositoryList> diagnosticRepository, string filePDF, string PathNegro, string PathBlanco)
        {
            ...
            try
            {
                ...
                {
                    new PdfPCell(new Phrase("Apellidos y Nombres: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].v_PersonName, fontColumnValue)),                   
                    new PdfPCell(new Phrase("N° Hs: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].v_ServiceId, fontColumnValue)),     
                    new PdfPCell(new Phrase("Doc. de Identidad: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].v_DocNumber, fontColumnValue)),     
                    new PdfPCell(new Phrase("Edad: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].i_Age.ToString(), fontColumnValue)),     
                    new PdfPCell(new Phrase("Empresa: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].v_OrganizationName, fontColumnValue)),     
                    new PdfPCell(new Phrase("Fecha de E.M.O: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].v_ServiceDate, fontColumnValue)),   
                    new PdfPCell(new Phrase("Puesto al que postula: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase( filiationData[0].i_EsoTypeId == "1" ?"" : filiationData[0].v_OccupationName, fontColumnValue)),   
                    new PdfPCell(new Phrase("Fecha de Nac.: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].d_BirthDate.Value.ToShortDateString(), fontColumnValue)),   
                    new PdfPCell(new Phrase("Ocupacion actual: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase( filiationData[0].i_EsoTypeId != "1" ?"" : filiationData[0].v_OccupationName, fontColumnValue)),   
                    new PdfPCell(new Phrase("Género: ", fontColumnValue)){HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].v_GenderName, fontColumnValue)),     
                    new PdfPCell(new Phrase("Examen Médico: ", fontColumnValue)){  HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].v_EsoTypeName, fontColumnValue)){Colspan=3},    
                    new PdfPCell(new Phrase("Grupo Sanguineo y Rh: ", fontColumnValue)){ HorizontalAlignment = Element.ALIGN_RIGHT }, new PdfPCell(new Phrase(filiationData[0].GrupoFactorSanguineo , fontColumnValue)){Colspan=3},                                    
