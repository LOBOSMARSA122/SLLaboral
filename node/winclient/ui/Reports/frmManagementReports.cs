    ...
    public partial class frmManagementReports : Form
    {
        ...
        private void frmManagementReports_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ConsolidadoReportes.Add(new ServiceComponentList { Orden = 4, v_ComponentName = "CERTIFICADO APTITUD SIN Diagnósticos ", v_ComponentId = Constants.INFORME_CERTIFICADO_APTITUD_SIN_DX });
