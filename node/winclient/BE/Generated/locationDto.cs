...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class locationDto
    {
        ...
        public locationDto(String v_LocationId, String v_OrganizationId, String v_Name, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, List<areaDto> area, organizationDto organization, List<nodeorganizationlocationwarehouseprofileDto> nodeorganizationlocationwarehouseprofile, List<warehouseDto> warehouse)
        {
