...
namespace Sigesoft.Node.WinClient.BLL
{
   public class CalendarBL
   {
       ...
       //                    join J6 in dbContext.systemparameter on new { a = B.i_SexTypeId.Value, b = 100 } equals new { a = J6.i_ParameterId, b = J6.i_GroupId }


       //                    join EE in dbContext.servicecomponent on new { a = D.v_ServiceId, b = "N002-ME000000022" }
       //                                                               equals new { a = EE.v_ServiceId, b = EE.v_ComponentId }

       //                    // Usuario Medico Evaluador / Medico Aprobador ****************************
       //                    join me in dbContext.systemuser on EE.i_ApprovedUpdateUserId equals me.i_SystemUserId into me_join
       ...
       //                         v_Genero = J6.v_Value1,
       //                         v_Ocupacion = B.v_CurrentOccupation,
       //                         v_MedicoEvaluador = me.v_UserName,
       //                         d_Birthdate = B.d_Birthdate.Value,
       //                        d_SalidaCM = A.d_SalidaCM
       ...
       //                         v_Genero = a.v_Genero,
       //                         v_Ocupacion =a.v_Ocupacion,
       //                         v_MedicoEvaluador = a.v_MedicoEvaluador,
       //                         i_Edad = GetAge(a.d_Birthdate)
       //                    }).ToList();




       //           List<CalendarList> objData = sql.ToList();
       //        pobjOperationResult.Success = 1;
       //        return objData;
